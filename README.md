...
# TombWatcher: A Red Team Simulation and Privilege Escalation Analysis
...
1. **Targeted Kerberoasting** via `WriteSPN` abuse.
2. **GMSA password retrieval** through group nesting.
3. **ForceChangePassword** to pivot laterally.
4. **Shadow Credentials** and **WriteOwner** chaining.
5. **AD Recycle Bin recovery** to resurrect a privileged certificate enrollment account.
6. **ESC15** exploitation of an unpatched AD CS template.
